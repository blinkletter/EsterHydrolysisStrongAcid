...
\centering
    \begin{tabular}{SSSS}
    \multicolumn{2}{c}{Table~1 of paper} & \multicolumn{2}{c}{Figure~1 Digitized} \\
...
%        \bottomrule
    \end{tabular} \label{tab:tab1}\vspace{-5mm}
\end{table}
